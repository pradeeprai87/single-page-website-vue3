  ...
  <v-app id="home">
    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">I'M Pradeep Rai</h1>
              <span class="text-grey">Full Stack - Developer</span><br />

              <v-btn tile dark class="text-yellow mt-8" variant="outlined" @click="scroll('biog')">
                Contact me
              </v-btn>
            </div>
          </v-col>
      ...
      <div class="text-center mt-4">
        <h2>Our Services and Domain</h2>
        <div style="width: 120px; margin: 0 auto; border-bottom: 1px solid black;"></div>
      </div>
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                <v-img src="s10.png" height="200px" cover></v-img>
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              ></v-btn
              ><br />
              <span class="text-caption">My Address here.....</span
              ><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">pradeeprai87@gmail.com </span> <br />
              <span class="text-caption">pradeeprai87@gmail.com </span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
